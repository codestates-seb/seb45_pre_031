...
function LoginPage () {
  ...
  const loginHanler = async (e) => {
    ...
    try {
      const response = await axios.post("ec2-3-36-128-133.ap-northeast-2.compute.amazonaws.com/v1/accounts/authenticate", { email, password });
  ...
  const googleLoginHandler = async () => {
    try {
      window.location.href = "ec2-3-36-128-133.ap-northeast-2.compute.amazonaws.com/oauth2/authorization/google";
    } catch (error) {
